        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          {isCustomer && (
            <div className="flex items-center gap-2">
              ...
              <Link
                to="/cart"
                className="p-2.5 rounded-xl hover:bg-green-50 text-gray-500 hover:text-green-600 transition-all duration-200 flex items-center gap-2"
              >
          ...
          {isLoggedIn ? (
            <div className="pt-4 border-t border-gray-100">
              ...
              <div className="flex items-center justify-between px-4 mb-3">
                ...
                <button
                  onClick={() => {
                    // Add signout logic here, assuming it clears state/redirects
                    // For now just refresh or similar as placeholder if no explicit action available
                    // Ideally import logout action
