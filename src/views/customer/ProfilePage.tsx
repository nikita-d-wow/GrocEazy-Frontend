                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                        <nav className="flex flex-row lg:flex-col">
                            <button
                                ...
                                className={`flex-1 lg:flex-none flex items-center gap-3 px-6 py-4 text-sm font-medium transition-colors border-b lg:border-b-0 lg:border-l-4 ${activeTab === 'info'
                            ...
                            <button
                                ...
                                className={`flex-1 lg:flex-none flex items-center gap-3 px-6 py-4 text-sm font-medium transition-colors border-b lg:border-b-0 lg:border-l-4 ${activeTab === 'address'
                                        ? 'border-green-600 bg-green-50 text-green-700'
                                        : 'border-transparent text-gray-600 hover:bg-gray-50 hover:text-gray-900'
                                    }`}
                            >
