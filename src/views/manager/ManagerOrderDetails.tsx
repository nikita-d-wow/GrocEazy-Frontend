...
export default function ManagerOrderDetails() {
  ...
  return (
    <div className="min-h-screen py-10 px-4 sm:px-6 lg:px-12 bg-transparent animate-fadeIn">
      <div className="max-w-4xl mx-auto space-y-6">
        {/* BACK BUTTON */}
        <button
          onClick={() => navigate('/manager/orders')}
          className="flex items-center gap-2 text-gray-600 hover:text-primary transition-colors group mb-4 cursor-pointer"
        >
        ...
        <div className="bg-white/70 backdrop-blur-xl border border-white/60 shadow-xl rounded-2xl overflow-hidden relative">
          ...
          <div className="p-6 sm:p-10">
            {/* HEADER */}
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8 mb-10 pb-8 border-b border-gray-100">
              ...
              <div className="flex-shrink-0 bg-white/50 p-4 rounded-2xl border border-white shadow-sm">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              {/* CUSTOMER INFO */}
              <div className="p-6 rounded-2xl bg-gradient-to-br from-blue-50/50 to-indigo-50/50 border border-blue-100/50 shadow-sm">
                <h3 className="text-sm font-bold text-blue-900 mb-5 flex items-center gap-2 uppercase tracking-wide">
              ...
              {/* SHIPPING & PAYMENT */}
              <div className="p-6 rounded-2xl bg-gradient-to-br from-emerald-50/50 to-teal-50/50 border border-emerald-100/50 shadow-sm">
                <h3 className="text-sm font-bold text-emerald-900 mb-5 flex items-center gap-2 uppercase tracking-wide">
                  <MapPin size={18} className="text-emerald-600" />
                  Shipping & Payment
                </h3>
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 rounded-xl bg-white flex items-center justify-center text-emerald-500 shadow-sm border border-emerald-50 shrink-0">
                      <MapPin size={18} />
                    </div>
                    <div>
                      <p className="text-xs text-gray-400 font-bold uppercase tracking-tight">
            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-4">
                {order.items.map((item: any, idx: number) => (
                  <div
                    key={idx}
                    className="flex justify-between items-center p-6 rounded-2xl bg-white/40 border border-white/60 hover:bg-white/80 hover:shadow-md transition-all group"
                  >
                    <div className="flex items-center gap-5">
                      <div className="w-12 h-12 rounded-xl bg-white flex items-center justify-center text-xs font-bold text-gray-400 border border-gray-100 shadow-sm group-hover:scale-105 transition-transform">
                        {idx + 1}
                      </div>
                      <div>
                        <p className="font-bold text-gray-900 text-base group-hover:text-primary transition-colors">
              ...
              {/* TOTAL SECTION */}
              <div className="mt-10 p-8 rounded-3xl bg-gray-900 text-white flex flex-col md:flex-row md:items-center md:justify-between gap-6 shadow-2xl relative overflow-hidden">
